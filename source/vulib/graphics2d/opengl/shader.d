module vulib.graphics2d.opengl.shader;
import vulib.graphics2d.opengl.glhelper : compileShader;
...
private:
    ...
    static immutable string defaultVertexShaderCode = "#version 300 es
...
void main() {
    ...
    static immutable string defaultFragmentShaderCode = "#version 300 es
precision highp float;
precision highp int;
in vec4 fColor;
in vec2 fTexCoords;
...
void main () {
    ...
    int _vertexShaderId, _fragmentShaderId;
public:
    bool compile()
    {
        return compileShader(this.defaultVertexShaderCode,
            GL_VERTEX_SHADER,
            _vertexShaderId)
            && compileShader(this.defaultFragmentShaderCode,
                GL_FRAGMENT_SHADER,
                _fragmentShaderId);
    }
}
